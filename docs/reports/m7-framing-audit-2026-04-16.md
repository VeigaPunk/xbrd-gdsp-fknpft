...
- **R1 Errata xlink:** The primary-source contradictions above (model-prefix naming demotion, errata on gate locus/stratification/IMCP attribution) originate in [xbreed-superiority-r1-2026-04-16.md §Errata](xbreed-superiority-r1-2026-04-16.md#errata-post-commit-cco-reviewer-novel-mirror-correction). H_C verdict depends on those errata being authoritative; if R1 errata are revised, re-run this ACH matrix.
