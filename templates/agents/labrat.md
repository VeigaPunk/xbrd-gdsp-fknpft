...
- **Gemini for breadth:** `xask gemini "<probe>"` — thinkingBudget=512, godspeed always loaded. Primary labrat channel.
...
Up to 8 labrats spawned in parallel. Each gets a unique hypothesis. No TaskCreate — fire-and-forget. Reports go to team-lead. Lead batch-shutdowns as DESPAWN signals arrive.
