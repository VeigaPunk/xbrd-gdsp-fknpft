...
- **Default delegation:** `xask --gpt55 --gs -e low codex "<review question>"` (gpt-5.5 + fast_mode + reasoning=low, uniform codex lane per 2026-04-24). For diffs spanning >10 files, pass `-scp <behavioral-change-files>` to scope the review. Temperature=0.1-0.3 for precision.
